 ...
 * indicate to the players whose turn it is. Depending on which player's turn it
 * is, the rectangle will be colored either red or blue.
 */
public class BoardTurnIndicator {
	 ...
	 *         BoardTurnIndicator to indicate when the player turn color has
	 *         changed.
	 */
