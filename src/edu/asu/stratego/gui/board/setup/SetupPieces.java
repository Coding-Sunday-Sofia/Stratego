...
public class SetupPieces {
	...
	public SetupPieces() {
		...
		String[] pieceSuffix = new String[] { "02", "03", "04", "05", "06", "07", "08", "09", "10", "BOMB", "SPY",
				"FLAG" };
	...
	/**
	 * This event is triggered when one of the piece type images are clicked on. It
	 * updates the HashMap that keeps track of which piece type is selected and adds
	 * a glow to the selected piece type's image.
	 */
	 ...
	 * @return the number of pieces of the PieceType have not been set on the board
	 *         yet
	 */
	...
	/**
	 * Decrements the piece type count by 1 and updates the piece type label. Runs a
	 * check to see if all the pieces have been placed. Signals SetupPanel to update
	 * the ready button if all of the pieces are placed.
	 * 
	...
	/**
	 * @return an array of ImageView objects that display images corresponding to
	 *         the piece type.
	 */
	...
	/**
	 * @return an array of JavaFX labels that display the number of pieces of each
	 *         piece type that still need to be placed.
	 */
