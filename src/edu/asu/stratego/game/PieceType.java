...
public enum PieceType {
	SCOUT(2, 8), MINER(3, 5), SERGEANT(4, 4), LIEUTENANT(5, 4), CAPTAIN(6, 4), MAJOR(7, 3), COLONEL(8, 2),
	GENERAL(9, 1), MARSHAL(10, 1), BOMB(-1, 6), SPY(-1, 1), FLAG(-1, 1);
	...
	/**
	 * Returns the result of a battle when one piece type attacks another piece
	 * type.
	 * 
