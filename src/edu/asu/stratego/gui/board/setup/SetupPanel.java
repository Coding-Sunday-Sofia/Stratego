...
public class SetupPanel {
	...
	public SetupPanel() {
		...
		setupPanel.setStyle("-fx-background-image: url(" + backgroundURL + "); " + "-fx-background-size: " + UNIT * 10
				+ " " + UNIT * 5 + ";" + "-fx-background-repeat: stretch;");
	...
	/**
	 * When the player has all of their pieces placed on the board and is ready to
	 * start playing, this method is called. Notifies the ClientGameManager to send
	 * the initial piece positions to the server and receive the opponent's initial
	 * piece positions.
	 */
	...
	/**
	 * Worker task that waits for a Setup Piece to be incremented or decremented. If
	 * all of the pieces have been placed, this task removes the instructions from
	 * the panel and adds the ready button to the panel. If the ready button is
	 */
